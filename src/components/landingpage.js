...
function Landingpage() {
  return (
    <>
      ...
      <div class=" w-full my-6  font-Quicksand flex flex-col items-center justify-center">
        <h1 class="text-4xl py-2.5 px-3 text-center bg-black text-white rounded-full font-bold">Our Hotels</h1>
        <div class="grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-4 sm:grid-cols-2 mb-6  ">
          ...
          <div class="mx-2 max-w-sm bg-slate-50 rounded-lg shadow-md  dark:bg-gray-800 dark:border-gray-700 ">
            ...
            <div class="flex flex-col justify-center items-center pb-10">
              ...
              <h1 class="text-center mt-4">starts from <h1 class="text-red-500 font-extrabold">Rp 788.976</h1></h1>
        ...
        <button
          type="button"
          class="text-white bg-yellow-400  text-xl hover:bg-yellow-500 focus:outline-none ofocus:ring-4 focus:ring-yellow-300 font-medium rounded-full px-5 py-2.5 text-center mr-2  dark:focus:ring-yellow-900"
        >
          More...
        </button>
      </div>
